module.exports = {
  tags: ['Create Lockup details'],
  description: 'Create a new Lockup_details',
  operationId: 'CreatLockupDetails',
  security: [
    {
      bearerAuth: [],
    },
      ...
      'application/x-www-form-urlencoded': {
        schema: {
          ...
          properties: {
            ...
            releases: {
              description: 'lockup details lock releases',
              type: 'number',
            },
            distribution_type: {
            ...
            schedule_type: {
              description: 'lockup details schedule_type',
              type: 'string',
            },
            graph_template_type: {
              description: 'lockup details graph_template_type',
              type: 'string',
            },
  ...
  responses: {
    200: {
      description: 'Lockup details created successfully',
    },
    401: {
